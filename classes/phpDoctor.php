...
// load classes
require('phpdoctor/classes/doc.php');
require('phpdoctor/classes/rootDoc.php');
require('phpdoctor/classes/packageDoc.php');
require('phpdoctor/classes/programElementDoc.php');
require('phpdoctor/classes/fieldDoc.php');
require('phpdoctor/classes/classDoc.php');
require('phpdoctor/classes/executableDoc.php');
require('phpdoctor/classes/constructorDoc.php');
require('phpdoctor/classes/methodDoc.php');
require('phpdoctor/classes/type.php');
require('phpdoctor/classes/tag.php');
